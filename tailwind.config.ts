  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "eco-points": {
          DEFAULT: "hsl(var(--eco-points))",
          foreground: "hsl(var(--eco-points-foreground))",
        },
        badge: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(var(--eco-points) / 0.3)" },
          "50%": { boxShadow: "0 0 40px hsl(var(--eco-points) / 0.6)" },
        },
        "scale-bounce": {
          "0%": { transform: "scale(1)" },
